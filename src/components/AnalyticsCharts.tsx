      ...
      <div className="h-60 w-full">
        {chartView === 'trends' && (
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={dailyData} margin={{ top: 10, right: 10, left: -25, bottom: 5 }}>
                ...
                formatter={(value: string) => {
                  const total =
                    value === 'Entries (Unlocks)'
                      ? dailyData.reduce((acc, cur) => acc + cur.unlocks, 0)
                      : dailyData.reduce((acc, cur) => acc + cur.locks, 0);
                  return (
                ...
                formatter={(value: string) => {
                  ...
                  return (
                    <span className="text-slate-300 text-xs ml-1">
                      {value} &mdash; Total: <strong className="text-white font-mono">{total} accesses</strong>
                    </span>
                  );
                }}
              />
            ...
            <BarChart data={userData} layout="vertical" margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
              ...
              <Legend
                ...
                formatter={(value: string) => {
                  ...
                  return (
                    <span className="text-slate-300 text-xs ml-1">
                      {value} &mdash; Combined: <strong className="text-white font-mono">{total} total</strong>
                    </span>
                  );
                }}
              />
