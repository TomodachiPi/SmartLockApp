...
const defaultLabNotes: LabNoteSchedule[] = [
  {
    ...
    startTime: '10:00 AM',
    endTime: '12:30 PM',
    purpose: 'Calibrating optics laser sensor and running sample batch B12.',
  ...
  },
  {
    ...
    username: 'Administrator',
    userRole: 'admin',
    title: 'Weekly Lock Hardware Diagnostics',
    date: '2026-08-31',
    startTime: '08:00 AM',
    endTime: '09:30 AM',
    purpose: 'Routine battery check and RFID actuator firmware verification.',
  ...
  },
  {
    ...
    userRole: 'user',
    title: 'Cell Culture Incubation Check',
    date: '2026-09-01',
    startTime: '02:00 PM',
    endTime: '04:00 PM',
    purpose: 'Monitoring bacterial growth curves in incubator chamber 3.',
    createdDate: 'Aug 29, 2026',
    status: 'confirmed',
  },
];

// Rich default history with realistic dates & timestamps for graphs & pagination
